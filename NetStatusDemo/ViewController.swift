...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        // MARK : availableInterfacesTypes가 왜 하나씩만 오지 wifi일 때는 wifi만 cellular일 때는 cellular만 오는데...?
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            cell.label.text = NetStatus.shared.isConntected ? "Connected" : "Not Connected"
            cell.indicationImageView.image = NetStatus.shared.isConntected ? UIImage(named: "checkmark") : UIImage(named: "delete")
        case 1:
